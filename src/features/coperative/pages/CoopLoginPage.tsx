...
const CoopLoginPage: React.FC = () => {
  ...
  const { register, handleSubmit, formState: { errors, isSubmitting }, setValue } = useForm<CoopLoginFormData>({
    resolver: zodResolver(coopLoginSchema)
  });
      ...
      <div className="w-full max-w-4xl bg-white md:rounded-[40px] shadow-2xl overflow-hidden flex flex-col md:flex-row min-h-[100vh] md:min-h-[600px]">
        ...
        <div className="hidden md:flex md:w-1/2 bg-[#2B1608] p-12 flex-col justify-between text-white relative">
          ...
          <div className="relative z-10">
            ...
            <p className="mt-6 text-white/70 text-lg leading-relaxed">
              Espace de gestion certifié pour les coopératives et unions de producteurs.
            </p>
          </div>
        ...
        <div className="w-full md:w-1/2 p-8 md:p-12 flex flex-col">
          <div className="flex items-center justify-between mb-8">
            ...
            <span className="md:hidden font-black text-[#3B1E08]">COOP PORTAL</span>
          </div>
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-500 text-sm mt-1">Identifiez votre organisation sur le réseau</p>
          </div>
          ...
          <div className="mt-auto pt-8 text-center">
            <p className="text-[9px] text-gray-400 uppercase tracking-[0.3em] font-black">Node de Validation #789 - Togo Network</p>
          </div>
        </div>
      </div>
    </div>
