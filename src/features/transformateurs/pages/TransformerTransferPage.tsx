...
export default function TransformerTransferPage() {
  ...
  const receivedLots: ReceivedLot[] = [
    {
      ...
      status: 'received',
      date: '2024-03-28',
      fromCooperative: 'Coopérative Kara',
      quality: 'Premium',
      eudrCompliant: true,
    ...
    },
    {
      ...
      status: 'transformed',
      date: '2024-03-30',
      fromCooperative: 'Coopérative Sokodé',
      quality: 'Premium',
      eudrCompliant: true,
  ...
  const validPartners: Partner[] = [
    {
      id: 'EXP-001',
      name: 'Togo Cacao Export International',
      type: 'exportateur',
      status: 'active',
      certifications: ['ISO 9001', 'Fair Trade', 'Organic'],
      location: 'Lomé, Togo',
      rating: 4.9,
      countries: ['France', 'Allemagne', 'Belgique', 'Suisse']
    },
    {
      id: 'EXP-002',
      name: 'West Africa Cacao Traders',
      type: 'exportateur',
      status: 'active',
      certifications: ['Rainforest Alliance', 'UTZ'],
      location: 'Kara, Togo',
      rating: 4.7,
      countries: ['Pays-Bas', 'Royaume-Uni', 'Italie']
    },
    {
      id: 'EXP-003',
      name: 'Premium Cacao Exports',
      type: 'exportateur',
      status: 'active',
      certifications: ['GlobalG.A.P', 'HACCP'],
      location: 'Sokodé, Togo',
      rating: 4.8,
      countries: ['USA', 'Canada', 'Japon']
    }
  ];
  ...
  const transferHistory: TransferRequest[] = [
    {
      ...
      toPartner: 'Togo Cacao Export International',
      weight: 600,
      status: 'confirmed',
      date: '2024-03-25',
      blockchainHash: '0x1a2b3c4d5e6f7a8b9c0d1e2f3a4b5c6d7e8f9a0b1c',
      qrCode: 'TRANS-2024-003-QR'
    },
    {
      id: 'TRANS-2024-004',
      lotId: 'LOT-2024-013',
      fromTransformer: 'Togo Chocoterie Industrielle',
      toPartner: 'West Africa Cacao Traders',
      weight: 450,
      status: 'confirmed',
      date: '2024-03-22',
      blockchainHash: '0x2b3c4d5e6f7a8b9c0d1e2f3a4b5c6d7e8f9a0b1c2d',
      qrCode: 'TRANS-2024-004-QR'
    }
  ];
  ...
  const filteredLots = receivedLots.filter(lot => 
    ...
    lot.fromCooperative.toLowerCase().includes(searchTerm.toLowerCase()) ||
    lot.origin.toLowerCase().includes(searchTerm.toLowerCase())
  );

  const handleLotSelection = (lotId: string) => {
    const lot = receivedLots.find(l => l.id === lotId);
  ...
  const getStatusColor = (status: string) => {
    switch (status) {
      case 'received': return 'text-amber-600 bg-amber-50';
        ...
        <div className="max-w-7xl mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-xl font-serif font-black text-cacao tracking-tight">Transfert de Lots Transformés</h1>
      ...
      <main className="max-w-7xl mx-auto px-6 py-8">
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              <h3 className="text-sm font-bold text-blue-800 mb-2">
                🏭 Workflow Transformateur → Exportateur
              </h3>
              <div className="space-y-1 text-xs text-blue-700">
                <p>• <span className="font-bold">Réception :</span> Vous ne recevez que des lots de coopératives partenaires validées</p>
                <p>• <span className="font-bold">Transformation :</span> Marquez les lots comme "TRANSFORMÉS" avant transfert</p>
                <p>• <span className="font-bold">Transfert :</span> Uniquement vers exportateurs validés par le Ministère</p>
                <p>• <span className="font-bold">Preuve :</span> Hash blockchain et QR code pour chaque transfert</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    ...
                    <div className="flex-1">
                      <div className="flex items-center gap-2 mb-2">
                        ...
                        <span className={`px-2 py-1 rounded-lg text-xs font-medium ${getStatusColor(lot.status)}`}>
                          {lot.transformed ? 'TRANSFORMÉ' : lot.status}
                        </span>
                        {lot.transformed && (
                          <Factory className="text-emerald-600" size={16} />
                        )}
                      </div>
                      ...
                      <div className="grid grid-cols-2 gap-2 text-sm">
                        ...
                        <div>
                          ...
                          <p className="font-bold text-cacao">{lot.fromCooperative}</p>
                        </div>
                        <div>
          ...
          <div className="bg-white rounded-2xl border border-cacao/10 p-6">
            <h2 className="text-lg font-serif font-black text-cacao mb-6 flex items-center gap-2">
              <Users size={20} />
              Exportateurs Partenaires Validés
            </h2>
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex-1">
                      ...
                      <div className="grid grid-cols-1 gap-2 text-sm">
                        ...
                        <div>
                          <span className="text-cacao/60">Pays desservis:</span>
                          <p className="font-bold text-cacao text-xs">{partner.countries.join(', ')}</p>
                        </div>
                        <div>
        ...
        <div className="mt-8 flex items-center justify-between">
          <div className="text-sm text-cacao/60">
            {selectedLots.length} lot(s) sélectionné(s) • {selectedPartner ? '1 exportateur sélectionné' : 'Aucun exportateur sélectionné'}
          </div>
            ...
            <div className="space-y-4 mb-6">
              <div className="bg-cacao/5 rounded-xl p-4">
                ...
                <div className="space-y-2 text-sm">
                  ...
                  <p><span className="font-medium">Pays de destination:</span> {selectedPartner?.countries.join(', ')}</p>
                </div>
              </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="text-sm font-bold text-blue-800 mb-1">
                      🏭 Transfert de lots transformés
                    </p>
                    <p className="text-xs text-blue-700">
                      Les lots seront marqués comme "TRANSFORMÉS" sur la blockchain 
                      avec preuve de transformation avant l'exportation.
                    </p>
                  </div>
                </div>
              </div>
