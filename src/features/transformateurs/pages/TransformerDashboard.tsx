// TODO [SIMULATED] This page uses hardcoded mock data. Replace with real API calls to lotService / cooperativeService.
// Backend integration needed: GET /lots?destinataireId=&statutTrajet=, GET /transformateur/stats
